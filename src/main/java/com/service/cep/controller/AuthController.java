...
import com.service.cep.dto.User;
...
public class AuthController {
    ...
    public ResponseEntity<String> token(@RequestBody User user) {
        ...
        var result = rt.postForEntity("http://localhost:8082/realms/rossiniwallace/protocol/openid-connect/token",entity, String.class);
